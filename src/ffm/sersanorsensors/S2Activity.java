...
public class S2Activity extends ActionBarActivity implements
		SensorEventListener {
	...
	public void sensorInfo() {
		...
		Sensor acc = sm.getDefaultSensor(Sensor.TYPE_LIGHT);
	...
	class transferData extends TimerTask {
	    public void run() {
			String tmp = "LIGHT: " + vx.getText().toString()+" s: 2 "; // SENDS LIGHT INFO
